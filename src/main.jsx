...
function App() {
  ...
  const moveEntry = (from, to) => { const list = [...draft]; const [m] = list.splice(from, 1); list.splice(to, 0, m); setDraft(list); };
